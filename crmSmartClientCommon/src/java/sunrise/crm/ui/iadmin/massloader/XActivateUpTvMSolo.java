...
@XWorksheet(rowOffset = 1, name = XConstants.ACTIVATE_UP_TV_SOLSO_M)

public class XActivateUpTvMSolo {
	...
	@XColumn(id = 23)
	public String ottDiscItemName;
	@XColumn(id = 24)
	public String ottDiscDuration;
	@XColumn(id = 25)
	public String ottDiscAmt;
	@XColumn(id = 26)
	public String rpAmt;
	...
	public String getOttDiscItemName() {
		return ottDiscItemName;
	}
	public void setottDiscItemName(String ottDiscItemName) {
		this.ottDiscItemName = ottDiscItemName;
	}
	public String getOttDiscDuration() {
		return ottDiscDuration;
	}
	public void setottDiscDuration(String ottDiscDuration) {
		this.ottDiscDuration = ottDiscDuration;
	}
	public String getOttDiscAmt() {
		return ottDiscAmt;
	}
	public void setottDiscAmt(String ottDiscAmt) {
		this.ottDiscAmt = ottDiscAmt;
	}
