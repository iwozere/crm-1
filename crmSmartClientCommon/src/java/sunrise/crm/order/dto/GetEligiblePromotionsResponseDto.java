...
public class GetEligiblePromotionsResponseDto {
    private List<OrderInfoDto> orderInfo = new ArrayList<OrderInfoDto>();
    private String application;
    private String basketInfo;
    private String transactionId;
    private String ineligibleReason;
    private static Log log = LogFactory.getLog(GetEligiblePromotionsResponseDto.class);
    ...
    public boolean equals(Object o) {
        ...
        GetEligiblePromotionsResponseDto responseDto = (GetEligiblePromotionsResponseDto) o;
        ...
        if (!Objects.equals(this.ineligibleReason, responseDto.ineligibleReason)) {
            log.debug("IneligibleReason is not equal.");
            return false;
        }
        if (!Objects.equals(this.orderInfo, responseDto.orderInfo)) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(orderInfo, application, basketInfo, transactionId
                , ineligibleReason, executionContext);
    }
}
